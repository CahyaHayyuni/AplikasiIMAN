...
if (isset($_POST['login'])) {
    ...
    $sql = $koneksi->query("select * from tb_anggota where nip='$username' and password='$pass' and user_login != 'notuser'");
...
?>
        <script>
            alert("Login Gagal. Data Tidak diketemukan / Username dan Password Anda Salah. Silahkan Coba Lagi");
        </script>
<?php
    }
}
